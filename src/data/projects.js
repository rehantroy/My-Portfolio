export const techProjects = [
  ...
  },
  {
    ...
    description:
      'Visualization and insights from real-world datasets using Python',
    bannerColor: 'from-amber-700 to-slate-900',
    stack: ['Python', 'Matplotlib', 'Pandas'],
    github: 'https://github.com/rehantroy/data-analysis-project',
  ...
  },
  {
    ...
    emoji: '🚀',
    name: 'Exciting Project #1',
    description: 'Coming Soon',
    bannerColor: 'from-cyan-800 to-slate-900',
    stack: [],
    github: '#',
    demo: '#',
  ...
  },
  {
    ...
    emoji: '⚡',
    name: 'Exciting Project #2',
    description: 'Coming Soon',
    bannerColor: 'from-indigo-800 to-slate-900',
    stack: [],
    github: '#',
    demo: '#',
    image: '/projects/coming-soon.png',
  ...
  {
    id: 'project-coming-soon-3',
    emoji: '✨',
    name: 'Exciting Project #3',
    description: 'Coming Soon',
    bannerColor: 'from-rose-800 to-slate-900',
    stack: [],
    github: '#',
    demo: '#',
    image: '/projects/coming-soon.png',
...
export const creativeVideoProjects = [
  {
    id: 'youtube-edit',
    label: 'YouTube Edit',
    context: 'Edited tech content — 5K+ views',
    type: 'YouTube Edit',
    videoId: 'dQw4w9WgXcQ',
  },
  {
    ...
    context: 'Created reels for college fest promotion',
    type: 'Instagram Reel',
    videoId: 'dQw4w9WgXcQ',
  },
  {
    id: 'short-clip',
    label: 'Short Clip',
    context: 'Short cinematic clip project',
    type: 'Short Clip',
    videoId: 'dQw4w9WgXcQ',
  },
]

export const creativeThumbnailProjects = [
  {
    id: 'thumbnail-1',
    label: 'Thumbnail 1',
  ...
  },
  {
    id: 'poster-1',
    label: 'Poster 1',
    image: '/projects/poster-1.png',
  },
  {
    id: 'poster-2',
    label: 'Poster 2',
    image: '/projects/poster-2.png',
  },
]
